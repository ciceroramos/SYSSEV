...
public class ViewClientes extends javax.swing.JFrame {
    ...
    private boolean salvarCliente() {
        ...
        if (jDate.getDate() == null || tfNome.getText().equals("") || tfTelefone.getText().equals("") || tfemail.getText().equals("") || tfCpfCnpj.getText().equals("")) {
            
            JOptionPane.showMessageDialog(this, "Você deve preencher NOME, Data Nascimento e Celular!", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            tfNome.requestFocus();
            return true;
