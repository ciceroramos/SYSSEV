...
public class Carregando extends javax.swing.JFrame {
    ...
    public Carregando() {
        initComponents();
        this.setIconImage(new ImageIcon("src/imagens/fenix trans.png").getImage());
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/aguarde128.gif"))); // NOI18N
